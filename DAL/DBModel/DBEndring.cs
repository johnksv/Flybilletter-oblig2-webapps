    ...
    public class DBEndring : IDBEndring
    {
        ...
        public List<Endring> Hent()
        {
            using (var db = new DB())
            {
                ...
                {
                    DALsetup.LogFeilTilFil(System.Reflection.MethodBase.GetCurrentMethod().Name, e, "En feil oppsto da metoden prøvde å hente alle registrerte endringer fra databasen");
                    return null;
                }
            }
        }
